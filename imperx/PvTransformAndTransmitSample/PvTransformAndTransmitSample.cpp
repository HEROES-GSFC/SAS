...
// * Receive video from a GEV device using PvStream and PvPipeline
...
// Using PvStream and PvPipeline, images are received from a GEV device on 
// channel 0.
//
...
//
// Using the PvTransmitterRaw class, the transformed image is continuously 
// transmitted to the specified destination.
// 
// By default, this sample prompts for a GEV device to receive from, begins 
// receiving from that device, resamples the video to RGB24 640X480, prints 
// "Hello World" on it and finally transmits it from the first valid interface 
